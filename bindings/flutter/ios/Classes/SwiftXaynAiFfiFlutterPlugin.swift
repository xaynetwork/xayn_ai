...
public class SwiftXaynAiFfiFlutterPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "xayn_ai_ffi_flutter", binaryMessenger: registrar.messenger())
    let instance = SwiftXaynAiFfiFlutterPlugin()
