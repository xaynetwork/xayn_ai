...
impl AddedVocabulary {
    ...
    pub fn token_to_id(&self, token: &str, model: &WordPiece) -> Option<u32> {
        self.added_tokens_map
            .get(token)
            .copied()
    ...
    pub fn id_to_token(&self, id: u32, model: &WordPiece) -> Option<String> {
    ...
    fn refresh_added_tokens(&mut self, model: &WordPiece, normalizer: Option<&BertNormalizer>) {
...
// mod tests {
//     use super::*;
//     use crate::{normalizer::OffsetReferential, pipeline::Token, pre_tokenizer::OffsetType, Error};
...
//     impl ModelMock {
//         fn tokenize(&self, _sequence: &str) -> Result<Vec<Token>, Error> {
//             unimplemented!()
//         }
...
//         let normalizer: Option<&BertNormalizer> = None;
